...
function Footer() {
  ...
  useEffect(() => {
    fetch("https://api.github.com/repos/muhammad-suleman/nextjs-portfolio")
  ...
  return (
    <footer>
      <Link
        href="https://github.com//muhammad-suleman"
        target="_blank"
        className="footer-link"
      >
        <span className="footer-info">Designed and Built by Muhammad Suleman.</span>
        {githubInfo && (
